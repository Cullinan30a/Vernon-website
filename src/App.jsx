          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <Card className="bg-white border-0 shadow-xl hover:shadow-2xl transition-all duration-300">
              <CardContent className="p-8 text-center">
                ...
                <h3 className="text-2xl font-bold text-gray-900 mb-4">Money & Finance Magazine 封面</h3>
                <p className="text-gray-600 mb-6">2023年封面人物</p>
                <img src={moneyFinanceMagazine} alt="Money & Finance Magazine Cover" className="w-full h-48 object-cover rounded-lg mb-4" />
                <p className="text-gray-600 leading-relaxed">
